            ...
            <div class="right-column">
                ...
                <div class="section-card">
                    ...
                    <div class="quick-actions">
                        <button class="action-btn" onclick="window.location.href='create_schedule.php'">
                            📅 Create Schedule
                        </button>
                        <button class="action-btn secondary" onclick="window.location.href='manage_routes.php'">
                            🗺️ Manage Routes
                        </button>
