...
// FormUtils - Shared utility functions
const FormUtils = {
    ...
    validateEmail(email) {
        ...
        if (!email) return { valid: false, message: 'Admin ID is required' };
    ...
    showNotification(message, type = 'info', parentElement = document.body) {
        ...
        notification.style.cssText = `
            ...
            right: 20px;
            padding: 16px 24px;
            background: ${type === 'error' ? '#ef4444' : type === 'success' ? '#22c55e' : '#06b6d4'};
            color: white;
            border-radius: 8px;
